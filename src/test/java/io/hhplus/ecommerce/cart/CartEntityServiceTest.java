...
import io.hhplus.ecommerce.cart.application.service.CartDomainService;
...
public class CartEntityServiceTest {
    ...
    void addCart_success_cart_exists() {
        ...
        // That
        assertThat(cartEntity.getQuantity()).isEqualTo(increaseQuantity + existingQuantity);
    }
    ...
    void addCart_success_cart_does_not_exist() {
        ...
        // when
        List<CartEntity> response = cartDomainService.addCart(userId, increaseQuantity, product);

        // That
        assertThat(response).contains(cartEntity);
        assertThat(cartEntity.getQuantity()).isEqualTo(increaseQuantity);
    }
    ...
    void removeCart_success_cart_exists() {
        ...
        // when
        List<CartEntity> response = cartDomainService.removeCart(userId, productId);
