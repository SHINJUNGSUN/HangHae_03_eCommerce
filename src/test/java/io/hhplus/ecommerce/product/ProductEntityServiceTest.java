...
import io.hhplus.ecommerce.product.application.service.ProductDomainService;
...
public class ProductEntityServiceTest {
    ...
    public void reduceProduct_Success() {
        ...
        // When
        ProductEntity updatedProduct = productDomainService.reduceProduct(productId, quantity);
